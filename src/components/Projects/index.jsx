      ...
      <article className="project-card">
        <div className="project-description-container">
          ...
          <p className="project-para">
            ...
            aggregation, web content rating and discussion application similiar
            to Reddit.
          </p>
          <p className="project-info">
            <span className="project-info__label">Tech Stack (Front-end):</span>{" "}
        ...
        <div className="project-image-container">
          ...
          <img className="project-image" src="/images/nc-news2-thumb.png"></img>
        </div>
      </article>
      ...
      <article className="project-card">
        <div className="project-description-container">
          ...
          <p className="project-para">
            ...
            randomly appearing targets that the user must click in order to
            accrue points. The application provides a leaderboard and
        ...
        <div className="project-image-container">
          <img className="project-image" src="/images/moat1-thumb.png"></img>
          <img className="project-image" src="/images/moat2-thumb.png"></img>
        </div>
      </article>
    </div>
  );
